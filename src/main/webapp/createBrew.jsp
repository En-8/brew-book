...
<div id="create-brew-container">
    <h1>Create a Brew</h1>
    <form action="createBrew" method="post" class="needs-validation" novalidate>
        <div class="multi-select">
            ...
            <div class="form-group">
                ...
                <select class="form-control form-select" name="style" id="style-select" required>
        ...
        <div class="multi-select" id="form-fermentables">
            ...
            <div class="form-row" id="fermentable-row-0">
                <div class="form-group col-6">
                    ...
                    <select class="form-control form-select" name="fermentable" id="fermentable-select-0" required>
                ...
                <div class="form-group col-2">
                    ...
                    <input class="form-control" type="text" name="fermentable-amount" id="fermentable-amount-0" required>
                </div>
                <div class="form-group col-2">
                ...
                <div class="col-2 form-group">
                    ...
                    <button class="form-control remove-fermentable remove-btn" id="remove-fermentable-0" value="0" type="button">Remove</button>
                </div>
            </div>
        ...
        <div class="multi-select" id="form-hops">
            ...
            <div class="form-row" id="hop-row-0">
                <div class="form-group col-5">
                    ...
                    <select class="form-control form-select" name="hop" id="hop-select-0" required>
                ...
                <div class="form-group col-1">
                    ...
                    <input class="form-control" type="text" name="hop-amount" id="hop-amount-0" required>
                </div>
                <div class="form-group col-1">
                ...
                <div class="form-group col-1">
                    ...
                    <input class="form-control" type="text" name="hop-time" id="hop-time-0" required>
                </div>
                <div class="form-group col-1">
                ...
                <div class="col-2 form-group">
                    ...
                    <button class="form-control remove-hop remove-btn" id="remove-hop-0" value="0" type="button">Remove</button>
                </div>
            </div>
            <div class="row button-form-row">
                <div class="col-5">
        ...
        <div class="multi-select" id="form-misc">
            ...
            <div class="form-row" id="misc-row-0">
                <div class="form-group col-5">
                    ...
                    <select class="form-control form-select" name="misc" id="misc-select-0" required>
                ...
                <div class="form-group col-1">
                    ...
                    <input class="form-control" type="text" name="misc-amount" id="misc-amount-0" required>
                </div>
                <div class="form-group col-1">
                ...
                <div class="form-group col-1">
                    ...
                    <input class="form-control" type="text" name="misc-time" id="misc-time-0" required>
                </div>
                <div class="form-group col-1">
                ...
                <div class="col-2 form-group">
                    ...
                    <button class="form-control remove-misc remove-btn" type="button" id="remove-misc-0" value="remove-misc-0">Remove</button>
                </div>
            </div>
            <div class="row button-form-row">
                <div class="col-5">
